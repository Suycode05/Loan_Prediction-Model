...
// CORS configuration
app.use(cors({
  origin: ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:3000', 'https://loan-prediction-model-eight.vercel.app', 'https://loan-prediction-ml-model.web.app','https://loan-prediction-model-1mnx.vercel.app','http://localhost:5173/prediction','https://loan-prediction-system.vercel.app'],
  credentials: true
